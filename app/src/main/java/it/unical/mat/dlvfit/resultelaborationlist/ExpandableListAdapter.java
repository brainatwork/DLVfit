...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private final SparseArray<ResultGroup> groups;
    public LayoutInflater inflater;
    public Activity activity;

    public ExpandableListAdapter(Activity act, SparseArray<ResultGroup> groups) {
        activity = act;
        this.groups = groups;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        ResultGroup group = (ResultGroup) getGroup(groupPosition);
