...
/**
 * Constants used in this project for ActivityRecognitionApi.
 */
public class RecognitionApiConstants {


    private RecognitionApiConstants() {
    }
     ...
     */
    public static long DETECTION_INTERVAL_IN_MILLISECONDS = 2000; //2 seconds

    /**
     * Indicates a confidence level acceptable to retain an activity reliable
     */
    public static int ADMISSIBLE_CONFIDENCE_LEVEL = 80;
